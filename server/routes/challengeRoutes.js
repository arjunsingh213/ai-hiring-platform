        ...
        if (attemptId) {
            ...
            if (attempt) {
                ...
                if (antiCheatData) {
                    ...
                    // Calculate detailed risk using risk engine
                    const riskResult = calculateAttemptRisk(antiCheatData, answers || []);
                    attempt.antiCheatLog.riskIndex = riskResult.riskIndex;
                    attempt.antiCheatLog.riskFactors = riskResult.factors;
                    // Override simple risk level with engine-calculated level
                    attempt.riskLevel = riskResult.riskLevel;
                }
