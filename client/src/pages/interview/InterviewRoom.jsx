...
const SVG_ICONS = {
    alert: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>,
    ban: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="4.93" y1="4.93" x2="19.07" y2="19.07" /></svg>,
    mic: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z" /><path d="M19 10v2a7 7 0 0 1-14 0v-2" /><line x1="12" y1="19" x2="12" y2="22" /></svg>,
    micMuted: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="1" y1="1" x2="23" y2="23" /><path d="M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V5a3 3 0 0 0-5.94-.6" /><path d="M17 16.95A7 7 0 0 1 5 12v-2m14 0v2a7 7 0 0 1-.11 1.23" /><line x1="12" y1="19" x2="12" y2="22" /></svg>,
    video: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="23 7 16 12 23 17 23 7" /><rect x="1" y="5" width="15" height="14" rx="2" ry="2" /></svg>,
    videoOff: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2m5.66 0H14a2 2 0 0 1 2 2v3.34l1 1L23 7v10" /><line x1="1" y1="1" x2="23" y2="23" /></svg>,
    users: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>,
    pin: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="17" x2="12" y2="22" /><path d="M5 17h14v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.68V6a3 3 0 0 0-6 0v4.68a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24Z" /></svg>,
    chat: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>,
    notes: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" /></svg>,
    transcript: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" /></svg>,
    ai: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2" /><circle cx="12" cy="5" r="2" /><path d="M12 7v4" /><line x1="8" y1="16" x2="8" y2="16" /><line x1="16" y1="16" x2="16" y2="16" /></svg>,
    code: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></svg>,
    ...
    screenShare: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" /><path d="M8 21h8" /><path d="M12 17v4" /></svg>,
    record: <svg width="1.2em" height="1.2em" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="3" fill="#ef4444" /></svg>,
    stop: <svg width="1.2em" height="1.2em" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="6" height="6" fill="#ef4444" /><circle cx="12" cy="12" r="10" /></svg>,
    phoneOff: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7 2 2 0 0 1 1.72 2v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.42 19.42 0 0 1-3.33-2.67m-2.67-3.34a19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91" /><line x1="23" y1="1" x2="1" y2="23" /></svg>,
    ...
    eraser: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21" /><path d="M22 21H7" /><path d="m5 11 9 9" /></svg>,
    ...
    circleGreen: <svg width="0.8em" height="0.8em" viewBox="0 0 24 24" fill="#10b981" stroke="#10b981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /></svg>,
    circleYellow: <svg width="0.8em" height="0.8em" viewBox="0 0 24 24" fill="#f59e0b" stroke="#f59e0b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /></svg>,
    circleRed: <svg width="0.8em" height="0.8em" viewBox="0 0 24 24" fill="#ef4444" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /></svg>,
    host: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14" /></svg>,
    candidate: <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
};
...
const InterviewRoom = () => {
        ...
        return (
            <div className="interview-room">
                <div className="ir-waiting-screen">
                    <div style={{ fontSize: '48px' }}>{SVG_ICONS.alert}</div>
    ...
    if (admissionStatus === 'denied') {
        return (
            <div className="interview-room">
                <div className="ir-waiting-screen">
                    <div style={{ fontSize: '48px' }}>{SVG_ICONS.ban}</div>
                    ...
                    <div className="ir-lobby-preview">
                        ...
                        <div className="ir-lobby-controls">
                            <button className={`ir-control-btn-lobby ${!audioEnabled ? 'muted' : ''}`} onClick={toggleAudio}>
                                {audioEnabled ? SVG_ICONS.mic : SVG_ICONS.micMuted}
                            </button>
                            <button className={`ir-control-btn-lobby ${!videoEnabled ? 'muted' : ''}`} onClick={toggleVideo}>
                                {videoEnabled ? SVG_ICONS.video : SVG_ICONS.videoOff}
                            </button>
                        </div>
                    </div>
        ...
        <div className="interview-room">
            ...
            <div className="ir-topbar">
                ...
                <div className="ir-topbar-center">
                    <span className="ir-timer"><span style={{ marginRight: "4px" }}>⏱</span> {formatTime(elapsedTime)}</span>
                    {roomData?.duration && (
                ...
                <div className="ir-topbar-right">
                    {userRole === 'recruiter' && (
                        <span className={`ir-integrity-badge ${roomData?.overallIntegrity || 'green'}`}>
                            {roomData?.overallIntegrity === 'green' ? SVG_ICONS.circleGreen : roomData?.overallIntegrity === 'yellow' ? SVG_ICONS.circleYellow : SVG_ICONS.circleRed}
                            ...
                            return (
                                <div key={socketId} className={`ir-video-tile ${pinnedParticipant === socketId ? 'pinned' : ''} ${pinnedParticipant && pinnedParticipant !== socketId ? 'sidebar-tile' : ''}`}>
                                    ...
                                    <div className={`ir-mic-indicator ${participant?.audioEnabled === false ? 'muted' : 'active'}`}>
                                        {participant?.audioEnabled === false ? SVG_ICONS.micMuted : SVG_ICONS.mic}
                                    </div>
                                    <button
                                    ...
                                    {userRole === 'recruiter' && (
                                        <div className="ir-admin-controls">
                                            ...
                                            >
                                                {participant?.videoEnabled === false ? SVG_ICONS.videoOff : SVG_ICONS.video}
                                            </button>
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="ir-side-panel">
                        <div className="ir-panel-header">
                            <span className="ir-panel-title">
                                {activePanel === 'chat' && <>{SVG_ICONS.chat} Chat</>}
                                {activePanel === 'participants' && <>{SVG_ICONS.users} Participants</>}
                                {activePanel === 'notes' && <>{SVG_ICONS.notes} Notes</>}
                                {activePanel === 'transcript' && <>{SVG_ICONS.transcript} Transcript</>}
                                {activePanel === 'ai' && <>{SVG_ICONS.ai} AI Assistant</>}
                                {activePanel === 'code' && <>{SVG_ICONS.code} Code Editor</>}
                                {activePanel === 'whiteboard' && <>{SVG_ICONS.palette} Whiteboard</>}
                            </span>
                                    ...
                                    <div className="ir-participant-item self">
                                        ...
                                        <div className="ir-participant-info">
                                            ...
                                            <div className="ir-participant-role">
                                                {userRole === 'recruiter' ? <span style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}>{SVG_ICONS.host} Host</span> : <span style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}>{SVG_ICONS.candidate} Candidate</span>}
                                            </div>
                                        </div>
                                    ...
                                    {participants.map((p) => (
                                        <div key={p.socketId} className="ir-participant-item">
                                            ...
                                            <div className="ir-participant-info">
                                                ...
                                                <div className="ir-participant-role">
                                                    {p.role === 'recruiter' ? <span style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}>{SVG_ICONS.host} Host</span> : <span style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}>{SVG_ICONS.candidate} Candidate</span>}
                                                </div>
                                            </div>
                                            <div className="ir-participant-status online"></div>
                                            ...
                                            {userRole === 'recruiter' && (
                                                <div className="ir-participant-actions">
                                                    ...
                                                    >
                                                        {p.audioEnabled === false ? SVG_ICONS.micMuted : '🎙️'}
                                                    </button>
                                                    <button
                                                        className="ir-admin-btn-sm"
                                                    ...
                                                    >
                                                        {p.videoEnabled === false ? SVG_ICONS.videoOff : SVG_ICONS.video}
                                                    </button>
                                                </div>
                                            )}
                                        </div>
                            ...
                            {activePanel === 'ai' && userRole === 'recruiter' && (
                                <div>
                                    {aiSuggestions.length === 0 ? (
                                        <div style={{ textAlign: 'center', color: 'rgba(255,255,255,0.3)', padding: '40px 0', fontSize: '13px' }}>
                                            <div style={{ fontSize: '32px', marginBottom: '12px' }}>{SVG_ICONS.ai}</div>
                            ...
                            {activePanel === 'whiteboard' && (
                                <div className="ir-whiteboard-container">
                                    <div className="ir-whiteboard-toolbar">
                                        <button className="ir-wb-tool-btn active" title="Pen">{SVG_ICONS.pen}</button>
                                        <button className="ir-wb-tool-btn" title="Eraser">{SVG_ICONS.eraser}</button>
                                        <button className="ir-wb-tool-btn" onClick={() => {
                                            socketRef.current?.emit('whiteboard-clear', { roomCode });
                                        }} title="Clear">{SVG_ICONS.trash}</button>
                                    </div>
                                    <canvas
            ...
            <div className="ir-controls">
                ...
                {userRole === 'recruiter' && (
                    ...
                    >
                        {isRecording ? SVG_ICONS.stop : SVG_ICONS.record}
                    </button>
                )}
